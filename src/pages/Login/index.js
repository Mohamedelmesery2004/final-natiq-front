...
const Login = () => {
    ...
    return (
        <div className="auth-wrapper">
            ...
            <div className={`auth-container ${isLoggingIn ? 'logging-in' : ''}`}>
                {isLoggingIn ? (
                    <div className="login-loading-screen">
                        <img src={logo} alt="NATIQ Logo" className="login-loading-logo" />
                    </div>
                ) : (
                    <>
                    ...
                    {isLogin && (
                        <>
                            <div className="input-group">
                                ...
                                <input className={loginStatus === 'error' ? 'input-error' : loginStatus === 'success' ? 'input-success' : ''} name="email" type="email" value={formData.email} onChange={handleChange} required placeholder="Email" />
                            </div>
                            <div className="input-group">
                                <label>Enter your password</label>
                                <input className={loginStatus === 'error' ? 'input-error' : loginStatus === 'success' ? 'input-success' : ''} name="password" type="password" value={formData.password} onChange={handleChange} required placeholder="Password" />
                            </div>
                        </>
                    )}
