...
const MOCK_MESSAGES = [
  { id: 1, from: "customer", text: "Hi, I booked a ticket but I didn't receive the confirmation email.", time: "10:30 AM" },
  { id: 2, from: "agent",    text: "No problem. Could you please share your booking number or email?", time: "10:31 AM" },
  { id: 3, from: "customer", text: "I used this email: example@email.com", time: "10:32 AM" },
  { id: 4, from: "agent",    text: "Thank you. I've found your booking and I'll resend the confirmation now.", time: "10:33 AM" },
  { id: 5, from: "customer", text: "Great, thank you.", time: "10:34 AM" },
  { id: 6, from: "agent",    text: "You're welcome! Let us know if you need any further help. 😊", time: "10:35 AM" },
  { id: 7, from: "customer", text: "I want to talk to your manger please.", time: "10:36 AM" },
];
    ...
    <div className="cd-tkt-layout">
      ...
      <div className="cd-tkt-right">
        <ChatWindow
          ...
          userName={selectedTicket?.name || "Select a ticket"}
          userStatus="Online"
    ...
    <div className="cd-layout">
      ...
      <div className="cd-right-panel">
        ...
        <main className="cd-main">
          ...
          {/* ── Dashboard view ── */}
          {activeNav !== "Tickets" && activeNav !== "Profile" && <>
